...
def create_app():
    ...
    app.config['MYSQL_DATABASE_USER'] = 'Restaurant'
    app.config['MYSQL_DATABASE_PASSWORD'] = open('/secrets/db_password.txt').readline()
    app.config['MYSQL_DATABASE_HOST'] = 'db'
    app.config['MYSQL_DATABASE_PORT'] = 3306
    app.config['MYSQL_DATABASE_DB'] = 'yelp_db'  # Change this to your DB name
    ...
    app.register_blueprint(restaurants,    url_prefix='/restaurant')
